            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text"> Dada la calificación de un alumno en la materia de matemá cas, determina si aprobó o 
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        un numero aleatorio para conseguir la edad).</p>
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        en qué intervalo está el usuario. U liza la estructura de control correcta.</p>
                        <a href="7/ejer7.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 7 -->
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        saltando de 50 en 50. Usar un bucle FOR para realizar el ejercicio, el po de cambio será 166,386. </p>
                        <a href="8/ejer8.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 8 -->
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">  Reper el ejercicio anterior usando WHILE.</p>
                        <a href="9/ejer9.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 9 -->
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <a href="10/ejer10.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>-+-
            <!-- Fin Ejercicio 10 -->
