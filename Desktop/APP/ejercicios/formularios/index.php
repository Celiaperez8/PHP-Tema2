            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Realiza un programa que pida dos números y luego muestre el resultado de su mulplicación.</p>
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Realiza un conversor de euros a pesetas. Ahora la can dad en euros que se quiere conver r se deberá introducir por 
                        teclado.</p>
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Realiza un conversor de pesetas a euros. La can dad en pesetas que se quiere conver r se deberá introducir por 
                        teclado.</p>
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <a href="4/index.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 4 -->
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Escribe un programa que calcule el total de una factura a par r de la base imponible.</p>
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Escribe un programa que calcule el salario semanal de un trabajador en base a las horas trabajadas. Se pagarán 12 
                        euros por hora.</p>
                        <a href="7/index.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 7 -->
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Realiza un conversor de Mb a Kb. </p>
                        <a href="8/index.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 8 -->
