            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Escribe un programa que calcule la media de un conjunto de números posi vos introducidos por teclado. A priori, el
                            programa no sabe cuántos números se introducirán. El usuario indicará que ha terminado de introducir los datos
                            cuando meta un número nega vo. Utiliza sesiones.</p>
                        <a href="1/ejer1.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 1 -->
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Realiza un programa que vaya pidiendo números hasta que se introduzca un numero nega vo y nos diga cuantos
                            números se han introducido, la media de los impares y el mayor de los pares. El número nega vo sólo se utiliza para
                            indicar el final de la introducción de datos, pero no se incluye en el cómputo. U liza sesiones. </p>
                        <a href="2/ejer2.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 2 -->
                ...
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Escribe un programa que permita ir introduciendo una serie indeterminada de números mientras su suma no supere
                            el valor 10000. Cuando esto úl mo ocurra, se debe mostrar el total acumulado, el contador de los números
                            introducidos y la media. U liza sesiones. </p>
                        <a href="3/ejer3.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 3 -->
                ...
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Establece un control de acceso mediante nombre de usuario y contraseña para cualquiera de los programas de la
                            relación anterior. La aplicación no nos dejará con nuar hasta que iniciemos sesión con un nombre de usuario y
                            contraseña correctos, almacenados previamente en una cookie. .</p>
                        <a href="4/ejer4.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 4 -->
                ...
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text">Escribe un programa que guarde en una cookie el color de fondo (propiedad background-color) de una página. Esta
                            página debe tener únicamente algo de texto y un formulario para cambiar el color.</p>
                        <a href="5/ejer5.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 5 -->
            ...
            <div class="col">
                <div class="card text-bg-success">
                    <div class="card-body">
                        ...
                        <a href="6/ejer6.php" class="btn btn-light">Acceder</a>
                    </div>
                </div>
            </div>
            <!-- Fin Ejercicio 6 -->
